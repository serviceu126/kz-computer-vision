...
class KioskEngine:
    ...
    def __init__(self) -> None:
        ...
        self.camera_stream_url = "http://127.0.0.1:8080/stream"
                # --- Счетчики смены (в памяти процесса, пока живёт uvicorn) ---
        self._today_packed: int = 0              # сколько кроватей упаковано
        self._idle_total_seconds: int = 0        # накопленный простой (сек)
        self._idle_started_at: float | None = None  # когда начался текущий простой
